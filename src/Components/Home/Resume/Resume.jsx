    ...
    <div className="resume-container">
      ...
      <section className="resume-section">
        ...
        <ul className="skills-list">
          ...
          <li>
            ...
            Design, Server-Side Rendering, JWT, OAuth, bcrypt, Axios, Fetch API,
            Web Audio API, HTML5 Canvas, Custom React Hooks, Algorithms
          </li>
          <li>
            <strong>Development Tools & Practices:</strong> Git, GitHub, VSCode,
            npm, Heroku, Netlify, Agile, Scrum, TDD/BDD, RSpec, Responsive
            Design, Cross-Browser Compatibility, Mobile-First Development,
            Component-based Architecture, Collision Detection (AABB)
          </li>
          <li>
      ...
      <section className="resume-section">
        ...
        <div className="project-item">
          ...
          <p>
            Developed a comprehensive e-commerce solution using React.js for the
            frontend and Node.js with Express.js for the backend, integrated
            with MongoDB. Implemented secure user authentication with JWT and
            bcrypt, along with a robust shopping cart system and intuitive
            product browsing experience. Utilized React Hooks for efficient
            state management and implemented RESTful API design principles.
          </p>
          <p>
            <a
        ...
        <div className="project-item">
          ...
          <p>
            Engineered an engaging endless runner game using React.js and HTML5
            Canvas, featuring custom pixel art and retro-style graphics.
            Implemented complex game mechanics, including collision detection,
            dynamic difficulty scaling, and custom controls for both desktop and
            mobile. Utilized requestAnimationFrame for smooth animations and
            game loop management. Integrated Web Audio API for immersive sound
            effects and background music, with user-controlled audio settings.
          </p>
          <p>
            <a
        ...
        <div className="project-item">
          ...
          <p>
            ...
            Implemented a sophisticated grid generation algorithm and intricate
            word highlighting system. Created a responsive design using CSS
            Flexbox and media queries for seamless play across various devices.
          </p>
          <p>
            <a
        ...
        <div className="project-item">
          ...
          <p>
            ...
            with custom CSS animations and transitions, fully responsive across
            all devices.
          </p>
          <p>
            <a
      ...
      <section className="resume-section">
        ...
        <div className="experience-item">
          ...
          <p>
            Led teams of 15+ employees, driving a 20% increase in sales through
            optimizing operations, improving workflows, and refining inventory
            management. Developed data-driven strategies to enhance operational
            efficiency and ensure smooth day-to-day functions. Managed key areas
            including scheduling, staffing, inventory, bookkeeping, and social
            media marketing, while ensuring compliance with health and safety
            regulations. Strong focus on team leadership, communication, and
            problem-solving, which resulted in improved team productivity and
            customer satisfaction. This role required a high level of
            adaptability, attention to detail, and a solution-oriented mindset,
            skills that are valuable in any professional environment.
          </p>
        </div>
        ...
        <div className="experience-item">
          ...
          <p>
            Designed and optimized over 50 analog and digital layouts for ICs in
            mobile devices using Cadence Virtuoso IC6.1. Utilized Cadence tools
            for schematic capture, layout design, and simulation, ensuring
            precise alignment and adherence to design rules. Conducted DRC and
            LVS verifications using Cadence Assura, reducing error rates.
      ...
      <section className="resume-section">
        <h2>Education</h2>
        <p>
          <strong>Arizona State University</strong> | Principles of Programming
          with Java | 2023
        </p>
        <p>
        ...
        <p>
          <strong>Portland Community College</strong> | Art / Mathematics Major
          | 2009-2011
        </p>
        <p>
